...
async def set_age(message, state):
    ...
    data = await state.get_data(['users_name', 'users_email', 'users_age'])
    add_user(username='XEX', email='oopping@ya.com', age=40)
    # add_user(str(data['users_name']), str(data['users_email']), int(data['users_age']))
